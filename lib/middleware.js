...
module.exports = function(options) {
	...
	if (options.customMiddleware)
	{
		...
		{
			for (customMiddlewareIndex = 0; customMiddlewareIndex < options.customMiddleware.length; customMiddlewareIndex++)
			{
				app.use(options.customMiddleware[customMiddlewareIndex](options));
			}
		}
	}
